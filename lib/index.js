...
var connect = function connect(component) {
  ...
  if ((typeof stateHandlers === 'undefined' ? 'undefined' : _typeof(stateHandlers)) === 'object' && params.length === 1 && stateHandlers.hasOwnProperty('reducer') && stateHandlers.hasOwnProperty('createActions') && stateHandlers.hasOwnProperty('initialState')) {
    var _reducer2 = stateHandlers.reducer,
        _createActions2 = stateHandlers.createActions,
        _initialState2 = stateHandlers.initialState,
        _stateHandlers$collec = stateHandlers.collect,
        _collect2 = _stateHandlers$collec === undefined ? false : _stateHandlers$collec;

    return createConnection(_reducer2, _createActions2, _initialState2, _collect2);
  }
